<template>
  <div class="performanceHouse">
    <div v-for="room in houseMess.room">
      ...
      <houseItem leftContent='累计收款' :redContent="room.allamount" rightContent="元" v-if="room.allamount != null"></houseItem>
      <houseItem v-for="shoukuan in houseMess.shoukuan" :leftContent="shoukuan.fundset" rightContent="元" :redContent="shoukuan.fundamount" v-if="houseMess.shoukuan.length > 0"></houseItem>
    </div>
