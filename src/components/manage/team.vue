<template>
  <div class="team">
    ...
    <div class="middle">
      ...
      <div class="left">
        <span class="blue">{{ renderList.totalamount }}</span><br>
    ...
    <div>
      <div class="teamItem" @click="jump(index)" v-for="(group, index) in renderList.group">
        <span class="left">{{ group.vsgname }}</span>
        <div class="right">
          <img src="../../assets/arrow-right.png">
          <div>
            <span>人数(人) : <span class="blue">{{ group.psnnum }}</span></span><br>
            <span v-if="checkedType != '预订'">金额(万元) : <span class="blue">{{ group.amount }}</span></span>
            <span v-if="checkedType == '预订'">套数(套) : <span class="blue">{{ group.amount }}</span></span>
          </div>
        </div>
      </div>
    </div>
